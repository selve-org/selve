  ...
  return (
    <div className="w-full">
      <textarea
        ...
        rows={rows}
        className="w-full bg-white dark:bg-[#1c1c1c] text-gray-900 dark:text-white border border-gray-300 dark:border-[#2e2e2e] rounded-[4px] px-4 py-3 text-[14px] placeholder:text-gray-400 dark:placeholder:text-[#666666] focus:outline-none focus:ring-1 focus:ring-purple-600 transition-all resize-none"
      />
